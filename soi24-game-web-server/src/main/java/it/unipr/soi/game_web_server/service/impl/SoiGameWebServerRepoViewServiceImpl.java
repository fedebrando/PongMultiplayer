...
@Service
public class SoiGameWebServerRepoViewServiceImpl implements SoiGameWebServerRepoViewService {

    private final GameDataRepo gameDataRepo;
    private final PlayerRepo playerRepo;

    public SoiGameWebServerRepoViewServiceImpl(GameDataRepo gameDataRepo, PlayerRepo playerRepo) {
